    ...
    if (process.platform === 'darwin') {
        template = [{
            ...
            submenu: [{
                ...
                label: 'Open Playground File...',
                accelerator: 'Command+Shift+O',
                click() {
                    mainWindow.webContents.send('menuActions', {action: 'openPlaygroundFile'})
                }
            }, {
                type: 'separator'
            }, {
                ...
                click() {
                    mainWindow.webContents.send('menuActions', {action: 'savePlaygroundFile'})
                }
            }]
        }, {
            label: 'Edit',
